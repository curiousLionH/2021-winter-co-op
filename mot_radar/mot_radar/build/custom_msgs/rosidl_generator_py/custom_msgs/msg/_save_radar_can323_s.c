...
bool custom_msgs__msg__save_radar_can323__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._save_radar_can323.SaveRadarCAN323", full_classname_dest, 50) == 0);
  }
  custom_msgs__msg__SaveRadarCAN323 * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of SaveRadarCAN323 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._save_radar_can323");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SaveRadarCAN323");
