...
#include "custom_msgs/msg/detail/object_inter_left__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectInterLeft__ros_msg_type = custom_msgs__msg__ObjectInterLeft;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ObjectInterLeft__ros_msg_type * ros_message = static_cast<const _ObjectInterLeft__ros_msg_type *>(untyped_ros_message);
  // Field name: object_0
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ObjectInterLeft__ros_msg_type * ros_message = static_cast<_ObjectInterLeft__ros_msg_type *>(untyped_ros_message);
  // Field name: object_0
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_custom_msgs__msg__ObjectInterLeft(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ObjectInterLeft__ros_msg_type * ros_message = static_cast<const _ObjectInterLeft__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ObjectInterLeft__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__ObjectInterLeft(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__ObjectInterLeft(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_custom_msgs__msg__ObjectInterLeft(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ObjectInterLeft = {
  "custom_msgs::msg",
  "ObjectInterLeft",
...
static rosidl_message_type_support_t _ObjectInterLeft__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ObjectInterLeft,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, ObjectInterLeft)() {
  return &_ObjectInterLeft__type_support;
}
