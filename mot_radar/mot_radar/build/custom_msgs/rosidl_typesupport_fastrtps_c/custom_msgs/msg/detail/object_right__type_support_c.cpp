...
#include "custom_msgs/msg/detail/object_right__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectRight__ros_msg_type = custom_msgs__msg__ObjectRight;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ObjectRight__ros_msg_type * ros_message = static_cast<const _ObjectRight__ros_msg_type *>(untyped_ros_message);
  // Field name: object_0
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ObjectRight__ros_msg_type * ros_message = static_cast<_ObjectRight__ros_msg_type *>(untyped_ros_message);
  // Field name: object_0
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_custom_msgs__msg__ObjectRight(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ObjectRight__ros_msg_type * ros_message = static_cast<const _ObjectRight__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ObjectRight__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__ObjectRight(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__ObjectRight(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_custom_msgs__msg__ObjectRight(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ObjectRight = {
  "custom_msgs::msg",
  "ObjectRight",
...
static rosidl_message_type_support_t _ObjectRight__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ObjectRight,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, ObjectRight)() {
  return &_ObjectRight__type_support;
}
