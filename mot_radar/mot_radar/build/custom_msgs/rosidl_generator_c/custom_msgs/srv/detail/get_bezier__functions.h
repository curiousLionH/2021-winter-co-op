...
#ifndef CUSTOM_MSGS__SRV__DETAIL__GET_BEZIER__FUNCTIONS_H_
#define CUSTOM_MSGS__SRV__DETAIL__GET_BEZIER__FUNCTIONS_H_
...
/// Initialize srv/GetBezier message.
/**
...
/// Finalize srv/GetBezier message.
/**
...
/// Create srv/GetBezier message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_msgs__srv__GetBezier_Request__init().
...
/// Destroy srv/GetBezier message.
/**
 * It calls
 * custom_msgs__srv__GetBezier_Request__fini()
...
/// Initialize array of srv/GetBezier messages.
/**
...
/// Finalize array of srv/GetBezier messages.
/**
 * It calls
 * custom_msgs__srv__GetBezier_Request__fini()
...
/// Create array of srv/GetBezier messages.
/**
 * It allocates the memory for the array and calls
 * custom_msgs__srv__GetBezier_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetBezier messages.
/**
 * It calls
 * custom_msgs__srv__GetBezier_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_msgs__srv__GetBezier_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_msgs
...
/**
 * It calls
 * custom_msgs__srv__GetBezier_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_msgs
...
/**
 * It allocates the memory for the array and calls
 * custom_msgs__srv__GetBezier_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_msgs
...
/**
 * It calls
 * custom_msgs__srv__GetBezier_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_MSGS__SRV__DETAIL__GET_BEZIER__FUNCTIONS_H_
