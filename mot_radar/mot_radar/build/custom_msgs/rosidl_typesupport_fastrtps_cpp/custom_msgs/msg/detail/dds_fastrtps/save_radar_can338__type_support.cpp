...
#include "custom_msgs/msg/detail/save_radar_can338__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::SaveRadarCAN338 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::SaveRadarCAN338 & ros_message)
{
  // Member: can_det_confid_azimuth
  cdr >> ros_message.can_det_confid_azimuth;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msgs
max_serialized_size_SaveRadarCAN338(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::SaveRadarCAN338 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::SaveRadarCAN338 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SaveRadarCAN338__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_msgs::msg::SaveRadarCAN338 *>(
...
{
  return max_serialized_size_SaveRadarCAN338(full_bounded, 0);
}

static message_type_support_callbacks_t _SaveRadarCAN338__callbacks = {
  "custom_msgs::msg",
  "SaveRadarCAN338",
...
static rosidl_message_type_support_t _SaveRadarCAN338__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SaveRadarCAN338__callbacks,
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_SaveRadarCAN338__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, SaveRadarCAN338)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_SaveRadarCAN338__handle;
}
