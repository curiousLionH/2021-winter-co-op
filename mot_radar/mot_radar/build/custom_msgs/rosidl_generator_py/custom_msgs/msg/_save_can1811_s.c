...
bool custom_msgs__msg__save_can1811__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._save_can1811.SaveCAN1811", full_classname_dest, 41) == 0);
  }
  custom_msgs__msg__SaveCAN1811 * ros_message = _ros_message;
  {  // lat_accel
  ...
  {  // brk_cylinder
    PyObject * field = PyObject_GetAttrString(_pymsg, "brk_cylinder");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->brk_cylinder = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of SaveCAN1811 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._save_can1811");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SaveCAN1811");
  ...
  {  // brk_cylinder
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->brk_cylinder);
    {
      int rc = PyObject_SetAttrString(_pymessage, "brk_cylinder", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
