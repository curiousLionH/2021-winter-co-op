...
{
  new (message_memory) custom_msgs::msg::VehicleControlIn(_init);
}

void VehicleControlIn_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msgs::msg::VehicleControlIn *>(message_memory);
  typed_message->~VehicleControlIn();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleControlIn_message_member_array[4] = {
  {
    "sw",  // name
    ...
    offsetof(custom_msgs::msg::VehicleControlIn, sw),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs::msg::VehicleControlIn, ax),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs::msg::VehicleControlIn, steer_ang),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs::msg::VehicleControlIn, gear_no),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleControlIn_message_members = {
  ...
  4,  // number of fields
  sizeof(custom_msgs::msg::VehicleControlIn),
...
{
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleControlIn_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msgs, msg, VehicleControlIn)() {
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleControlIn_message_type_support_handle;
}
