...
class Metaclass_SaveRadarCAN328(type):
    """Metaclass of message 'SaveRadarCAN328'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_msgs.msg.SaveRadarCAN328')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__save_radar_can328
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__save_radar_can328
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__save_radar_can328
            cls._TYPE_SUPPORT = module.type_support_msg__msg__save_radar_can328
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__save_radar_can328
...
class SaveRadarCAN328(metaclass=Metaclass_SaveRadarCAN328):
    """Message class 'SaveRadarCAN328'."""
