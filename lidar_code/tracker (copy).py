...
from kalmanFiltercopy import UnscentedKalmanFilter
...
class Tracks(object):
    ...
    def __init__(self, detection, trackId,v_x,v_y,object_points,dt, box_dict = None):
        ...
        points = MerweScaledSigmaPoints(4, alpha=.1, beta=2., kappa=-1)   # points 추가 
        
        
        
        self.KF = UnscentedKalmanFilter(dim_x = 4, dim_z = 2, dt = dt, fx = fx, hx = hx, points = points)   
        self.KF.predict(dt)
