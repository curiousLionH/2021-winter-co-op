...
scenario_num = str(20)
print(os.getcwd() + '/lidar_data_pcd')
# file_list = (os.listdir(os.getcwd() + '/lidar_data_pcd/'))
file_list = natsort.natsorted(os.listdir(os.getcwd() + '/lidar_data_pcd/'))  # sorted(os.listdir('/home/amlab/SemanticKITTI_point/dataset/sequences_0.06/' + scenario_num + '/velodyne/'))
print(file_list)
os.chdir(os.getcwd() + '/lidar_data_pcd/')  # os.chdir('/home/amlab/SemanticKITTI_point/dataset/sequences_0.06/' + scenario_num + '/velodyne/') # change dir
# print(file_list)
