...
bool custom_msgs__msg__sbg_can338__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._sbg_can338.SbgCAN338", full_classname_dest, 37) == 0);
  }
  custom_msgs__msg__SbgCAN338 * ros_message = _ros_message;
  {  // acc_x
...
{
  /* NOTE(esteve): Call constructor of SbgCAN338 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._sbg_can338");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SbgCAN338");
