...
bool custom_msgs__msg__object_left__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._object_left.ObjectLeft", full_classname_dest, 39) == 0);
  }
  custom_msgs__msg__ObjectLeft * ros_message = _ros_message;
  {  // object_0
...
{
  /* NOTE(esteve): Call constructor of ObjectLeft */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._object_left");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjectLeft");
