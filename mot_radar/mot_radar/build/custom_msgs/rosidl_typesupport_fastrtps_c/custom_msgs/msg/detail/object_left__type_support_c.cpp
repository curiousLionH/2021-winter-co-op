...
#include "custom_msgs/msg/detail/object_left__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectLeft__ros_msg_type = custom_msgs__msg__ObjectLeft;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ObjectLeft__ros_msg_type * ros_message = static_cast<const _ObjectLeft__ros_msg_type *>(untyped_ros_message);
  // Field name: object_0
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ObjectLeft__ros_msg_type * ros_message = static_cast<_ObjectLeft__ros_msg_type *>(untyped_ros_message);
  // Field name: object_0
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_custom_msgs__msg__ObjectLeft(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ObjectLeft__ros_msg_type * ros_message = static_cast<const _ObjectLeft__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ObjectLeft__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__ObjectLeft(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__ObjectLeft(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_custom_msgs__msg__ObjectLeft(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ObjectLeft = {
  "custom_msgs::msg",
  "ObjectLeft",
...
static rosidl_message_type_support_t _ObjectLeft__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ObjectLeft,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, ObjectLeft)() {
  return &_ObjectLeft__type_support;
}
