...
bool custom_msgs__msg__cam_to_dm__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._cam_to_dm.CamToDM", full_classname_dest, 34) == 0);
  }
  custom_msgs__msg__CamToDM * ros_message = _ros_message;
  {  // objects
    ...
    Py_ssize_t size = 10;
    custom_msgs__msg__Object * dest = ros_message->objects;
...
{
  /* NOTE(esteve): Call constructor of CamToDM */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._cam_to_dm");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CamToDM");
