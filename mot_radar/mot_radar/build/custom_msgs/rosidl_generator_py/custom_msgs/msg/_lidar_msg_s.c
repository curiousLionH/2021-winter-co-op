...
bool custom_msgs__msg__lidar_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._lidar_msg.LidarMsg", full_classname_dest, 35) == 0);
  }
  custom_msgs__msg__LidarMsg * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of LidarMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._lidar_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LidarMsg");
