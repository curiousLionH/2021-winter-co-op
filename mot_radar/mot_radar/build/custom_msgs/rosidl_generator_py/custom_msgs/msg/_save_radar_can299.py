...
class Metaclass_SaveRadarCAN299(type):
    """Metaclass of message 'SaveRadarCAN299'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_msgs.msg.SaveRadarCAN299')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__save_radar_can299
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__save_radar_can299
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__save_radar_can299
            cls._TYPE_SUPPORT = module.type_support_msg__msg__save_radar_can299
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__save_radar_can299
...
class SaveRadarCAN299(metaclass=Metaclass_SaveRadarCAN299):
    """Message class 'SaveRadarCAN299'."""
