...
bool custom_msgs__msg__sbg_can515__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._sbg_can515.SbgCAN515", full_classname_dest, 37) == 0);
  }
  custom_msgs__msg__SbgCAN515 * ros_message = _ros_message;
  {  // time_offset_0
...
{
  /* NOTE(esteve): Call constructor of SbgCAN515 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._sbg_can515");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SbgCAN515");
