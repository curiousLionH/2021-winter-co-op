...
bool custom_msgs__msg__debug_raw_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._debug_raw_array.DebugRawArray", full_classname_dest, 46) == 0);
  }
  custom_msgs__msg__DebugRawArray * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of DebugRawArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._debug_raw_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DebugRawArray");
