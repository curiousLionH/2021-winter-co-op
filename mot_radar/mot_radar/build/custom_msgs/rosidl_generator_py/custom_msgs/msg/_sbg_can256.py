...
class Metaclass_SbgCAN256(type):
    """Metaclass of message 'SbgCAN256'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_msgs.msg.SbgCAN256')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sbg_can256
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sbg_can256
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sbg_can256
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sbg_can256
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sbg_can256
...
class SbgCAN256(metaclass=Metaclass_SbgCAN256):
    """Message class 'SbgCAN256'."""
    ...
    def general_status(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 65536, \
                "The 'general_status' field must be an unsigned integer in [0, 65535]"
    ...
    def clock_status(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 65536, \
                "The 'clock_status' field must be an unsigned integer in [0, 65535]"
