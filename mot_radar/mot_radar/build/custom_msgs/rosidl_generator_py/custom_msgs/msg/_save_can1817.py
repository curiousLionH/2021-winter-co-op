...
class Metaclass_SaveCAN1817(type):
    """Metaclass of message 'SaveCAN1817'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_msgs.msg.SaveCAN1817')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__save_can1817
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__save_can1817
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__save_can1817
            cls._TYPE_SUPPORT = module.type_support_msg__msg__save_can1817
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__save_can1817
...
class SaveCAN1817(metaclass=Metaclass_SaveCAN1817):
    """Message class 'SaveCAN1817'."""
    ...
    def str_status(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'str_status' field must be an unsigned integer in [0, 255]"
    ...
    def ped1_status(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'ped1_status' field must be an unsigned integer in [0, 255]"
    ...
    def ped2_status(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'ped2_status' field must be an unsigned integer in [0, 255]"
