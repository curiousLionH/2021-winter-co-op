...
#include "custom_msgs/msg/detail/object_left__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::ObjectLeft & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::ObjectLeft & ros_message)
{
  // Member: object_0
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msgs
max_serialized_size_ObjectLeft(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static bool _ObjectLeft__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  auto typed_message =
    static_cast<const custom_msgs::msg::ObjectLeft *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}

static bool _ObjectLeft__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  auto typed_message =
    static_cast<custom_msgs::msg::ObjectLeft *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ObjectLeft__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_msgs::msg::ObjectLeft *>(
...
static size_t _ObjectLeft__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ObjectLeft(full_bounded, 0);
}

static message_type_support_callbacks_t _ObjectLeft__callbacks = {
  "custom_msgs::msg",
  "ObjectLeft",
  _ObjectLeft__cdr_serialize,
  _ObjectLeft__cdr_deserialize,
  _ObjectLeft__get_serialized_size,
  _ObjectLeft__max_serialized_size
};

static rosidl_message_type_support_t _ObjectLeft__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ObjectLeft__callbacks,
...
get_message_type_support_handle<custom_msgs::msg::ObjectLeft>()
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_ObjectLeft__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, ObjectLeft)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_ObjectLeft__handle;
}
