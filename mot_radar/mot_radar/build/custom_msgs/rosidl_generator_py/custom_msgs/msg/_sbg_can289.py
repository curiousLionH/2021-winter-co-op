...
class Metaclass_SbgCAN289(type):
    """Metaclass of message 'SbgCAN289'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_msgs.msg.SbgCAN289')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sbg_can289
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sbg_can289
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sbg_can289
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sbg_can289
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sbg_can289
...
class SbgCAN289(metaclass=Metaclass_SbgCAN289):
    """Message class 'SbgCAN289'."""
