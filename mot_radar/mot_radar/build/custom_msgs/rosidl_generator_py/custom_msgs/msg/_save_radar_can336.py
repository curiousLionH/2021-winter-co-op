...
class Metaclass_SaveRadarCAN336(type):
    """Metaclass of message 'SaveRadarCAN336'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_msgs.msg.SaveRadarCAN336')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__save_radar_can336
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__save_radar_can336
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__save_radar_can336
            cls._TYPE_SUPPORT = module.type_support_msg__msg__save_radar_can336
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__save_radar_can336
...
class SaveRadarCAN336(metaclass=Metaclass_SaveRadarCAN336):
    """Message class 'SaveRadarCAN336'."""
