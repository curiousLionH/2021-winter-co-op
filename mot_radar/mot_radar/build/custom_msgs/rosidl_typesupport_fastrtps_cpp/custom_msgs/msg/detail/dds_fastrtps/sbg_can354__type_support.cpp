...
#include "custom_msgs/msg/detail/sbg_can354__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::SbgCAN354 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::SbgCAN354 & ros_message)
{
  // Member: time_stamp
  cdr >> ros_message.time_stamp;
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::SbgCAN354 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::SbgCAN354 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SbgCAN354__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_msgs::msg::SbgCAN354 *>(
...
{
  return max_serialized_size_SbgCAN354(full_bounded, 0);
}

static message_type_support_callbacks_t _SbgCAN354__callbacks = {
  "custom_msgs::msg",
  "SbgCAN354",
...
static rosidl_message_type_support_t _SbgCAN354__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SbgCAN354__callbacks,
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_SbgCAN354__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, SbgCAN354)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_SbgCAN354__handle;
}
