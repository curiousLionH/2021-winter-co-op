...
#ifndef CUSTOM_MSGS__MSG__DETAIL__SAVE_CAN1817__STRUCT_HPP_
#define CUSTOM_MSGS__MSG__DETAIL__SAVE_CAN1817__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__custom_msgs__msg__SaveCAN1817 __attribute__((deprecated))
#else
# define DEPRECATED__custom_msgs__msg__SaveCAN1817 __declspec(deprecated)
#endif
...
struct SaveCAN1817_
{
  using Type = SaveCAN1817_<ContainerAllocator>;

  explicit SaveCAN1817_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit SaveCAN1817_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  // pointer types
  using RawPtr =
    custom_msgs::msg::SaveCAN1817_<ContainerAllocator> *;
  using ConstRawPtr =
    const custom_msgs::msg::SaveCAN1817_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<custom_msgs::msg::SaveCAN1817_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<custom_msgs::msg::SaveCAN1817_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      custom_msgs::msg::SaveCAN1817_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<custom_msgs::msg::SaveCAN1817_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<custom_msgs::msg::SaveCAN1817_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<custom_msgs::msg::SaveCAN1817_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<custom_msgs::msg::SaveCAN1817_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__custom_msgs__msg__SaveCAN1817
    std::shared_ptr<custom_msgs::msg::SaveCAN1817_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__custom_msgs__msg__SaveCAN1817
    std::shared_ptr<custom_msgs::msg::SaveCAN1817_<ContainerAllocator> const>
  ...
  bool operator==(const SaveCAN1817_ & other) const
  {
...
using SaveCAN1817 =
  custom_msgs::msg::SaveCAN1817_<std::allocator<void>>;
...
#endif  // CUSTOM_MSGS__MSG__DETAIL__SAVE_CAN1817__STRUCT_HPP_
