...
static const _VehicleInfoOut_type_support_symbol_names_t _VehicleInfoOut_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, VehicleInfoOut)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_msgs, msg, VehicleInfoOut)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_msgs, msg, VehicleInfoOut)() {
  return &::custom_msgs::msg::rosidl_typesupport_c::VehicleInfoOut_message_type_support_handle;
}
