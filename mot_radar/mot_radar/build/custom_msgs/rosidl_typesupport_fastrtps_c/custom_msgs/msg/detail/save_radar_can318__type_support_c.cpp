...
#include "custom_msgs/msg/detail/save_radar_can318__rosidl_typesupport_fastrtps_c.h"
...
using _SaveRadarCAN318__ros_msg_type = custom_msgs__msg__SaveRadarCAN318;

static bool _SaveRadarCAN318__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SaveRadarCAN318__ros_msg_type * ros_message = static_cast<const _SaveRadarCAN318__ros_msg_type *>(untyped_ros_message);
...
static bool _SaveRadarCAN318__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _SaveRadarCAN318__ros_msg_type * ros_message = static_cast<_SaveRadarCAN318__ros_msg_type *>(untyped_ros_message);
  // Field name: can_det_confid_azimuth
  {
    cdr >> ros_message->can_det_confid_azimuth;
  }
...
size_t get_serialized_size_custom_msgs__msg__SaveRadarCAN318(
  const void * untyped_ros_message,
...
static uint32_t _SaveRadarCAN318__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__SaveRadarCAN318(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__SaveRadarCAN318(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _SaveRadarCAN318__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_custom_msgs__msg__SaveRadarCAN318(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_SaveRadarCAN318 = {
  "custom_msgs::msg",
  "SaveRadarCAN318",
  _SaveRadarCAN318__cdr_serialize,
  _SaveRadarCAN318__cdr_deserialize,
  _SaveRadarCAN318__get_serialized_size,
  _SaveRadarCAN318__max_serialized_size
};

static rosidl_message_type_support_t _SaveRadarCAN318__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SaveRadarCAN318,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, SaveRadarCAN318)() {
  return &_SaveRadarCAN318__type_support;
}
