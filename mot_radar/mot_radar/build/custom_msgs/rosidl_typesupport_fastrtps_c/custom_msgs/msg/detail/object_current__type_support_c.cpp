...
#include "custom_msgs/msg/detail/object_current__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectCurrent__ros_msg_type = custom_msgs__msg__ObjectCurrent;

static bool _ObjectCurrent__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ObjectCurrent__ros_msg_type * ros_message = static_cast<const _ObjectCurrent__ros_msg_type *>(untyped_ros_message);
  // Field name: object_0
  {
...
static bool _ObjectCurrent__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _ObjectCurrent__ros_msg_type * ros_message = static_cast<_ObjectCurrent__ros_msg_type *>(untyped_ros_message);
  // Field name: object_0
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_custom_msgs__msg__ObjectCurrent(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ObjectCurrent__ros_msg_type * ros_message = static_cast<const _ObjectCurrent__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ObjectCurrent__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__ObjectCurrent(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__ObjectCurrent(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _ObjectCurrent__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_custom_msgs__msg__ObjectCurrent(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ObjectCurrent = {
  "custom_msgs::msg",
  "ObjectCurrent",
  _ObjectCurrent__cdr_serialize,
  _ObjectCurrent__cdr_deserialize,
  _ObjectCurrent__get_serialized_size,
  _ObjectCurrent__max_serialized_size
};

static rosidl_message_type_support_t _ObjectCurrent__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ObjectCurrent,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, ObjectCurrent)() {
  return &_ObjectCurrent__type_support;
}
