...
# topview_param = o3d.io.read_pinhole_camera_parameters('/home/'+ hostname + '/coop_ws/src/2021-winter-co-op/lidar_code/top_viewpoint_600x900.json')
# perspectiveview_param = o3d.io.read_pinhole_camera_parameters('/home/'+ hostname + '/coop_ws/src/2021-winter-co-op/lidar_code/perspective_viewpoint_600x900.json')
...
class Mot(Node):
    def __init__(self):
        ...
        self.draw_pcd = o3d.geometry.PointCloud()
...
def main(args=None):
    ...
    while rclpy.ok():
        ...
        xyz_o3d.points = o3d.utility.Vector3dVector(lidar_xyz)
        tr.vis.update_geometry(xyz_o3d)
