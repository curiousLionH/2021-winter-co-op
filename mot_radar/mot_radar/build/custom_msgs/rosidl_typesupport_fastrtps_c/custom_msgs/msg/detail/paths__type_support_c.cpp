...
#include "rosidl_runtime_c/primitives_sequence.h"  // h, id, s, x, y
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // h, id, s, x, y
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: s
  {
    ...
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->s, size)) {
      return "failed to create array for field 's'";
    }
    auto array_ptr = ros_message->s.data;
    cdr.deserializeArray(array_ptr, size);
  }
