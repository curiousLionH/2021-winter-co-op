...
bool custom_msgs__msg__vehicle_info_out__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._vehicle_info_out.VehicleInfoOut", full_classname_dest, 48) == 0);
  }
  custom_msgs__msg__VehicleInfoOut * ros_message = _ros_message;
  {  // cycleno
...
PyObject * custom_msgs__msg__vehicle_info_out__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._vehicle_info_out");
