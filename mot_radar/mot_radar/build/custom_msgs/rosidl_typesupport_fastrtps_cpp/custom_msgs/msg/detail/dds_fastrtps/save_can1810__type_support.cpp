...
#include "custom_msgs/msg/detail/save_can1810__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::SaveCAN1810 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::SaveCAN1810 & ros_message)
{
  // Member: wheel_spd_fr
  cdr >> ros_message.wheel_spd_fr;
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::SaveCAN1810 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::SaveCAN1810 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SaveCAN1810__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_msgs::msg::SaveCAN1810 *>(
...
{
  return max_serialized_size_SaveCAN1810(full_bounded, 0);
}

static message_type_support_callbacks_t _SaveCAN1810__callbacks = {
  "custom_msgs::msg",
  "SaveCAN1810",
...
static rosidl_message_type_support_t _SaveCAN1810__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SaveCAN1810__callbacks,
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_SaveCAN1810__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, SaveCAN1810)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_SaveCAN1810__handle;
}
