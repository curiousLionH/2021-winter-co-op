...
#include "custom_msgs/msg/detail/object_inter__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::ObjectInter & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::ObjectInter & ros_message)
{
  // Member: object_0
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msgs
max_serialized_size_ObjectInter(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::ObjectInter *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::ObjectInter *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ObjectInter__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_msgs::msg::ObjectInter *>(
...
{
  return max_serialized_size_ObjectInter(full_bounded, 0);
}

static message_type_support_callbacks_t _ObjectInter__callbacks = {
  "custom_msgs::msg",
  "ObjectInter",
...
static rosidl_message_type_support_t _ObjectInter__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ObjectInter__callbacks,
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_ObjectInter__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, ObjectInter)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_ObjectInter__handle;
}
