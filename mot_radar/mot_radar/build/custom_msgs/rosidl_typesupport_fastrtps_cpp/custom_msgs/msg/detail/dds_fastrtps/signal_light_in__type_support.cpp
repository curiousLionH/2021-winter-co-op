...
#include "custom_msgs/msg/detail/signal_light_in__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::SignalLightIn & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::SignalLightIn & ros_message)
{
  // Member: signal_light
  cdr >> ros_message.signal_light;
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::SignalLightIn *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::SignalLightIn *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_SignalLightIn__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, SignalLightIn)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_SignalLightIn__handle;
}
